...
You need a Kubernetes cluster to try these examples 

Navigate to different folders to try different kustomize concepts. copy different <*>-kustomization.yaml  files into kustomization.yaml file to try different concepts
...
Before trying a different kustomization yaml, delete the resources 
